def filtering_category(database: dict[str, dict],
    ...
    if category_key is not None:
        result = [product for product in database.values() if product.get('category') == category_key]  # TODO При помощи фильтрации в list comprehension профильтруйте товары по категории (ключ 'category') в продукте database. Или можете использовать
